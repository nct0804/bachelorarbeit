...
class KeywordMatcher:
    ...
    async def _initialize_keyword_registry(self) -> None:
        ...
        try:
            ...
            from robotmcp.config.library_registry import get_library_names_for_loading # type: ignore
    ...
    async def _context_aware_matching(
        ...
        from robotmcp.config.library_registry import get_libraries_by_category, LibraryCategory # type: ignore
        context_libraries = {
